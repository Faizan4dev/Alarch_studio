  ...
  return (
    <div className="w-full bg-white">
      ...
      <div className="container-main py-14 md:py-16 xl:py-20 flex flex-col md:flex-row items-start gap-10 xl:gap-14">
        ...
        {/* LEFT CONTENT */}
        <div className="w-full md:w-[48%] xl:w-[60%] 2xl:w-[45%] pt-10">

          <h1 className="heading-hero max-w-[100%]">
            Where Ideas <br /> Become Spaces
          </h1>

          <p className="text-body mt-6 w-full">
          ...
          <BookConsultation className="btn-primary mt-6" />
        ...
        <div className="w-full md:w-[52%] relative group overflow-hidden rounded-2xl">
          ...
          <img
            src={heroGrid}
            alt="projects"
            className="w-full h-[260px] sm:h-[320px] md:h-[440px] xl:h-[540px] 2xl:h-[800px] object-cover transition duration-700 ease-out group-hover:scale-[1.03]"
          />
