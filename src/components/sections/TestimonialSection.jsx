...
const testimonials = [
  { text: "I appreciate Alarch Studio's attentiveness, professionalism, and effective communication. They managed to bring my idea to fruition...", name: "Dreamattic", img: prsn66, flag: flagSK, country: "Slovakia" },
  ...
  { text: "Alarch Studio's done a amazing job on our project with incredible attention to details and outstanding visual appeal.", name: "Jalicia", img: prsn9, flag: flagUS, country: "United States" },
  { text: "Thrilled with Alarch Studio's work! Highly recommend for 3D interior modeling projects!", name: "Cazpey", img: prsn10, flag: flagGR, country: "Germany" },
...
// Show 3 cards at a time on md+
const VISIBLE = 3;
const TOTAL_PAGES = testimonials.length - VISIBLE + 1;
