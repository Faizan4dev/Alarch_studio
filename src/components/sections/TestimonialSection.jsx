    ...
    <div className="bg-[#fff] py-24">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        <div className="mt-16 flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          {/* LEFT ARROW */}
          <button className="w-10 h-10 border rounded-full flex items-center justify-center icon-hover">
            ←
          </button>
          ...
          <div className="flex flex-col md:flex-row gap-10 text-center md:text-left">
            ...
            {/* CARD 1 */}
            <div className="max-w-xs mx-auto transition duration-300 hover:opacity-80">
              ...
              <div className="mt-6 flex flex-col items-center">
                <img
                  src={prsn6}
                  alt="client"
                  className="w-10 h-10 rounded-full object-cover border border-gray-200 transition duration-300 hover:scale-110"
                />
                <p className="mt-3 font-serif italic transition duration-300 hover:text-black">
                  Dreamattic
                </p>
